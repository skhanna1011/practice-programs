...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { body: @publication.body, instructor_id: @publication.instructor_id, title: @publication.title } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { body: @publication.body, instructor_id: @publication.instructor_id, title: @publication.title } }
