...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { bio: @instructor.bio, mobile_no: @instructor.mobile_no, name: @instructor.name } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { bio: @instructor.bio, mobile_no: @instructor.mobile_no, name: @instructor.name } }
